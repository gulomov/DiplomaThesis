...
data class FavoriteProduct(
    ...
    @PropertyName("images") val images: List<ProductImages>? = null,
    @PropertyName("title") val title: String? = null,
    @PropertyName("salePercentage") val salePercentage: Int? = null,
    @PropertyName("saleStartsDate") val saleStartsDate: String? = null,
    @PropertyName("saleEndsDate") val saleEndsDate: String? = null,
    @PropertyName("originalPrice") val originalPrice: Int? = null,
    @PropertyName("priceOnSale") val priceOnSale: Int? = null,
    @PropertyName("sizes") val sizes: List<ProductSizes>? = null,
) {
